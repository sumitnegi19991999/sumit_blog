...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-8">
      ...
      <h1 className="font-semibol mb-8 cursor-pointer text-center text-3xl transition duration-700 hover:text-pink-600 ">
      ...
      <p className="mb-8 px-5 text-center text-lg font-normal text-gray-700 lg:px-20">
        {post.excerpt}
      </p>
